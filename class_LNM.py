...
class LNM_hedge:
    def __init__(self, api_key):
        ...
        self.base_url = "https://api.lnmarkets.com" #placeholder for the actual lnmakets url
    ...
    def hedge_position(self, delta):
        try:
            ...
            if response.status_code == 200:
                ...
                logging.error(f"Failed to perform Hedging. Status code: {response.status_code}")

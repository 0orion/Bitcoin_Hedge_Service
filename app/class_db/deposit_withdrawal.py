...
class LNMarkets_Deposit_Withdraw:
    ...
    def deposit_satoshis(self, amount):
        ...
        try:
            ...
            data = {"amount": amount}  # amount in sats
            ...
            if response.status_code == 200:
                ...
                logging.info(f"Deposit successful: {result}")
                return result
            else:
                logging.error(
                    f"Failed to deposit satoshis. Status code: {response.status_code}"
                )
    ...
    def withdraw_satoshis(self, amount):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logging.error(
                    f"Failed to withdraw satoshis. Status code: {response.status_code}"
                )
